...
# Milestone details:-->
  ...
  * Milestone-6 API micro-service module code is in currently released for deployment on Amazon Cloud
  ...
  * The application can be found on https://ec2-52-36-218-253.us-west-2.compute.amazonaws.com:8443/upload --> testing URL
