...
public class PbsConstants {
	...
	public final static String bigRedModule="module load PrgEnv-gnu \nmodule load fftw\n module load cudatoolkit"
	...
	public final static String bigRedJobRun="aprun -n 16 /N/soft/cle4/gromacs/gnu/single/4.6.5/bin/mdrun_mpi -v -deffnm pdb1y6l-EM-vacuum.tpr -c pdb1y6l-EM-vacuum.gro";
